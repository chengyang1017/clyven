  ...
  Component _settingsPanel() {
    ...
    return div(classes: 'watch-player-settings-layer', [
      div(classes: 'watch-subtitle-settings-card', [
        ...
        // Display placement is independent from language/script selection.
        div(classes: 'watch-subtitle-placement', [
          div(classes: 'watch-subtitle-placement-title', [
            strong([.text('显示位置')]),
          ]),
          div(classes: 'watch-subtitle-placement-options', [
            button(
              type: ButtonType.button,
              classes:
                  'watch-setting-chip'
