    ...
    return div(classes: 'script-conversion-page', [
      ...
      div(classes: 'script-conversion-layout', [
              ...
              for (final item in profiles)
                button(
                  ...
                  [
                    ...
                    span([
                      .text('Mode: ${item.conversionMode ?? 'dictionary'}'),
                    ]),
                  ],
                ),
            ]),
        ...
        section(classes: 'script-conversion-panel', [
          ...
          p(classes: 'admin-muted', [
            .text(
              'dictionary = words/phrases; rules = characters/sequences; hybrid = dictionary + rules + exceptions.',
            ),
          ]),
          if (createError != null)
        ...
        section(classes: 'script-conversion-panel', [
          div(classes: 'script-conversion-section-header', [
            div([
              ...
              p(classes: 'admin-muted', [
                .text(
                  'Types: dictionary, exception, sequence, character. Exceptions run before dictionary, then rules.',
                ),
              ]),
            ]),
            button(
                ...
                div(classes: 'script-entry-card', [
                  if (editingEntryId == entry.id) ...[
                    div(classes: 'script-entry-edit-grid', [
                      ...
                      _field('Type', entryType, (value) => entryType = value),
