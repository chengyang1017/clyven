...
class _SubtitleVideoPanelState extends State<SubtitleVideoPanel> {
  ...
  void _toggleFullscreen() {
    final shell = html.document.getElementById(
      'subtitle-video-shell',
    );
  ...
  Component build(BuildContext context) {
    ...
    return div(
      id: 'subtitle-video-shell',
      classes: 'subtitle-video-panel',
      [
        div(
          classes: 'subtitle-player-stage',
          [
            dom.video(
              [],
            ...
            div(
              classes: 'subtitle-player-topbar',
              [
                span(
                  classes: 'subtitle-player-badge',
                  [
                    .text('CLYVEN PREVIEW'),
                  ],
                ),
            ...
            div(
              classes: 'subtitle-player-controls',
              [
                div(
                  classes: 'subtitle-player-progress-wrap',
                  [
                    input<String>(
                ...
                div(
                  classes: 'subtitle-player-control-row',
                  [
                    div(
                      classes: 'subtitle-player-control-group',
                      [
                        button(
                          type: ButtonType.button,
                          classes:
                    ...
                    div(
                      ...
                      [
                        span(
                          classes: 'subtitle-player-volume-icon',
                          [
                            .text(_volumeIcon()),
                          ],
                        ),
