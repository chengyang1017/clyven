...
class SubtitleCreatePanel extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return div(
      classes: 'subtitle-create-panel',
      [
        div(
          classes: 'subtitle-create-header',
          [
            h3([
              .text('Add subtitle'),
            ]),
        ...
        div(
          classes: 'subtitle-create-fields',
          [
            label(
              [
                span([
            ...
            label(
              classes: 'subtitle-create-text-field',
              [
                span([
                  .text('Subtitle'),
                ]),
