...
class _SubtitleCueListState extends State<SubtitleCueList> {
  ...
  Component build(BuildContext context) {
    ...
    return div(
      classes: 'subtitle-editor-main',
      [
        div(
          classes: 'subtitle-editor-list-header',
          [
            span([
              .text('Timeline'),
            ]),
        ...
        if (remaining > 0)
          div(
            classes: 'subtitle-cue-load-more',
            [
              button(
  ...
  Component _buildRow(int index) {
    ...
    return SubtitleCueRow(
      ...
      savingTiming:
          cueId != null &&
          component.savingTimingCueIds.contains(cueId),
      savingText:
          cueId != null &&
          component.savingCueIds.contains(cueId),
      deleting:
          cueId != null &&
          component.deletingCueIds.contains(cueId),
      timingError:
          cueId == null ? null : component.timingErrors[cueId],
      saveError:
          cueId == null ? null : component.saveErrors[cueId],
      deleteError:
          cueId == null ? null : component.deleteErrors[cueId],
      onRowClick: () {
        component.onRowClick(detail);
      },
      onStartChanged: (value) {
        if (cueId != null) {
          component.onStartChanged(
            cueId,
            value,
          );
        }
