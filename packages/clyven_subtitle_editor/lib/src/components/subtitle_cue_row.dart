...
class SubtitleCueRow extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    return div(
      ...
      [
        div(classes: 'subtitle-editor-time', [
          span(classes: 'subtitle-row-number', [.text('$number')]),
          if (cueId != null)
            div(classes: 'subtitle-timing-editor', [
              ...
              button(
                ...
                attributes: savingTiming ? {'disabled': 'disabled'} : null,
        ...
        div(classes: 'subtitle-editor-text', [
          textarea([.text(text)], onInput: onTextChanged),
          if (cueId != null)
            div(classes: 'subtitle-editor-actions', [
              button(
                classes: 'subtitle-save-button',
                attributes: savingText ? {'disabled': 'disabled'} : null,
                onClick: savingText
                    ? null
                    : () {
                        onSaveText();
              ...
              button(
                ...
                attributes: deleting ? {'disabled': 'disabled'} : null,
                onClick: deleting
                    ? null
                    : () {
                        onDelete();
              ...
              if (deleteError != null)
                span(classes: 'subtitle-save-error', [.text(deleteError!)]),
            ]),
        ]),
