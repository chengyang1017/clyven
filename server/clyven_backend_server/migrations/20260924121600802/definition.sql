...
--
-- Class AppProfile as table app_profile
--
...
--
-- Class CreatorFollow as table creator_follow
--
...
--
-- Class ScriptConversionEntry as table script_conversion_entry
--
...
--
-- Class ScriptConversionProfile as table script_conversion_profile
--
...
CREATE TABLE "video" (
    ...
    "contentType" text NOT NULL DEFAULT 'video'::text,
    "languageCode" text,
    "tags" json NOT NULL,
    "videoStorageKey" text NOT NULL,
    "coverStorageKey" text,
    "hlsManifestStorageKey" text,
    "transcoderJobName" text,
    "transcodeState" text,
...
--
-- Class VideoFavorite as table video_favorite
--
...
--
-- Class WatchHistory as table watch_history
--
...
--
-- Foreign relations for "video_favorite" table
--
...
--
-- Foreign relations for "watch_history" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('clyven_backend', '20260924121600802', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260924121600802', "timestamp" = now();
