...
abstract class SubtitleReviewDashboard
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'secondReviewCount': secondReviewCount,
      'completedCount': completedCount,
      'unclaimed': unclaimed.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'mine': mine.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'secondReview': secondReview.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      'completed': completed.toJson(valueToJson: (v) => v.toJsonForProtocol()),
    };
  }
