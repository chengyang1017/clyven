...
class _VideoDetailPageState extends ConsumerState<VideoDetailPage> {
  ...
  Widget _buildContent(
    ...
    final primarySelection = resolvePrimarySubtitleSelection(
      subtitleTracks,
      subtitleState,
    );
    final secondarySelection = resolveSecondarySubtitleSelection(
      subtitleTracks,
      subtitleState,
    );
            ...
            child: Stack(
              children: [
                _buildPersistentPlayer(
                  ...
                  onSubtitlesPressed: subtitleTracks.isEmpty
                      ? null
                      : () {
